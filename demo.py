...
from distance import people_yolo_detector
from distance import SDD
...
video_src = "PXL_20210322_101239438.mp4"  # The Video Path to analyze
...
ocv.add_analyze_filter(inference.YoloMask())
ocv.add_analyze_filter(MaskCounter())
ocv.add_analyze_filter(people_yolo_detector.YoloPerson())
ocv.add_analyze_filter(SDD.SocialDistance())
